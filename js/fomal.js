...
function tonav() {
  ...
  document.getElementById("page-name").innerText = document.title.split(" | 且听风吟🥝")[0];
}
...
$.ajax({
  ...
  data: {
    key: 'KHWBZ-MK73T-MZZXI-LBIZL-KO7MV-JDBRC',  // 这里要写你的KEY!!!
    output: 'jsonp',
  },
  dataType: 'jsonp',
...
function showWelcome() {
  ...
  let dist = getDistance(117.22901, 31.82057, ipLoacation.result.location.lng, ipLoacation.result.location.lat); //这里换成自己的经纬度
...
function createtime1() {
  var grt = new Date("05/25/2023 00:00:00"); //此处修改你的建站时间或者网站上线时间
...
function createtime2() {
  ...
  setTimeout(
    console.warn.bind(
      console,
      "%c ⚡ Powered by 且听风吟🥝 %c 你正在访问且听风吟🥝の小家",
...
document.querySelector('body').classList.contains('DarkMode') ? changeToLight() : changeToNight();  // 设置默认为lightly

/* 夜间模式切换动画 start */
function switchNightMode() {
  document.querySelector('body').insertAdjacentHTML('beforeend', '<div class="Cuteen_DarkSky"><div class="Cuteen_DarkPlanet"><div id="sun"></div><div id="moon"></div></div></div>'),
    setTimeout(function () {
      document.querySelector('body').classList.contains('DarkMode') ? (document.querySelector('body').classList.remove('DarkMode'), localStorage.setItem('isDark', '0'), document.getElementById('modeicon').setAttribute('xlink:href', '#icon-moon'), changeToLight()) : (document.querySelector('body').classList.add('DarkMode'), localStorage.setItem('isDark', '1'), document.getElementById('modeicon').setAttribute('xlink:href', '#icon-sun'), changeToNight()),
        setTimeout(function () {
...
function share_() {
  ...
  try {
    ...
    var subTitle = title.endsWith("| 且听风吟🥝") ? title.substring(0, title.length - 14) : title;
    navigator.clipboard.writeText('且听风吟🥝的站内分享\n标题：' + subTitle + '\n链接：' + url + '\n欢迎来访！🍭🍭🍭');
    new Vue({
      data: function () {
        this.$notify({
          title: "成功复制分享信息🎉",
...
function createtime() {
  ...
  // 网站诞生时间
  var grt = new Date("05/25/2023 00:00:00");
  ...
  (currentTimeHtml =
    hnum < 18 && hnum >= 9
      ? `<img class='boardsign' src='https://cdn.staticaly.com/gh/HcGys/DataSource@main/badge/F小屋-科研摸鱼中.svg' title='什么时候能够实现财富自由呀~'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`
      : `<img class='boardsign' src='https://cdn.staticaly.com/gh/HcGys/DataSource@main/badge/F小屋-下班休息啦.svg' title='下班了就该开开心心地玩耍~'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`),
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/dm14.webp);
    --darkmode-bg:url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/yuanshen1.webp);
    --mobileday-bg: url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/snow.webp);
    --mobilenight-bg: url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/mb8.webp);
  }`;
}
// 切换背景主函数
function changeBg(s) {
...
<details class="folding-tag" cyan><summary> 查看二次元背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/yuanshen1.webp)" class="imgbox" onclick="changeBg('url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/yuanshen1.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/dm15.webp)" class="imgbox" onclick="changeBg('url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/dm15.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/dm2.webp)" class="imgbox" onclick="changeBg('url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/dm2.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/dm7.webp)" class="imgbox" onclick="changeBg('url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/dm7.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/dm8.webp)" class="imgbox" onclick="changeBg('url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/dm8.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/dm3.webp)" class="imgbox" onclick="changeBg('url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/dm3.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/dm11.webp)" class="imgbox" onclick="changeBg('url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/dm11.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/dm12.webp)" class="imgbox" onclick="changeBg('url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/dm12.webp)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看风景背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/fj1.webp)" class="imgbox" onclick="changeBg('url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/fj1.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/fj2.webp)" class="imgbox" onclick="changeBg('url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/fj2.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/fj3.webp)" class="imgbox" onclick="changeBg('url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/fj3.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/fj4.webp)" class="imgbox" onclick="changeBg('url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/fj4.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/fj5.webp)" class="imgbox" onclick="changeBg('url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/fj5.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/fj6.webp)" class="imgbox" onclick="changeBg('url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/fj6.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/fj7.webp)" class="imgbox" onclick="changeBg('url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/fj7.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/fj8.webp)" class="imgbox" onclick="changeBg('url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/fj8.webp)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看萌宠背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/mc1.webp)" class="imgbox" onclick="changeBg('url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/mc1.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/mc2.webp)" class="imgbox" onclick="changeBg('url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/mc2.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/mc3.webp)" class="imgbox" onclick="changeBg('url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/mc3.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/mc4.webp)" class="imgbox" onclick="changeBg('url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/mc4.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/mc5.webp)" class="imgbox" onclick="changeBg('url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/mc5.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/mc6.webp)" class="imgbox" onclick="changeBg('url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/mc6.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/mc7.webp)" class="imgbox" onclick="changeBg('url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/mc7.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/mc8.webp)" class="imgbox" onclick="changeBg('url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/mc8.webp)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看适配手机的背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/mb4.webp)" class="pimgbox" onclick="changeBg('url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/mb4.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/mb5.webp)" class="pimgbox" onclick="changeBg('url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/mb5.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/mb6.webp)" class="pimgbox" onclick="changeBg('url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/mb6.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/mb7.webp)" class="pimgbox" onclick="changeBg('url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/mb7.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/mb8.webp)" class="pimgbox" onclick="changeBg('url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/mb8.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/mb9.webp)" class="pimgbox" onclick="changeBg('url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/mb9.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/mb16.webp)" class="pimgbox" onclick="changeBg('url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/mb16.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/mb19.webp)" class="pimgbox" onclick="changeBg('url(https://cdn.staticaly.com/gh/HcGys/DataSource@main/img/mb19.webp)')"></a></div>
              </div>
            </details>
